...
//insert ke tabel
	$query = "INSERT INTO kategori(nm_kategori,deskripsi) VALUES('$judul','$headline')";
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<ol class="breadcrumb">
				...
				<li><i class="fa fa-laptop"></i>Input Kategori</li>						  	
			</ol>
		</div>
	</div>
					...
					<div class="form">
						<form class="form-validate form-horizontal" id="feedback_form" method="POST" name="input" action="">
							<div class="form-group ">
								...
								<div class="col-lg-10">
									<input class="form-control" id="cname" name="nama" minlength="1" type="text" required />
								</div>
							</div>
							<div class="form-group ">
